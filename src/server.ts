...
import { DialogOptions, NotificationOptions, MCPToolResult } from './types.js';
...
class MCPServer {
  ...
  private setupHandlers(): void {
    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
      ...
      try {
        switch (name) {
          case 'ask_human':
            return await this.handleAskHuman(args as unknown as DialogOptions);
          case 'notify_human':
            return await this.handleNotifyHuman(args as unknown as NotificationOptions);
          default:
  ...
  private async handleAskHuman(options: DialogOptions): Promise<MCPToolResult> {
  ...
  private async handleNotifyHuman(options: NotificationOptions): Promise<MCPToolResult> {
  ...
  private formatDialogResponse(options: DialogOptions, value: any): string {
